    ...
    <>
      ...
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-11/12 max-w-lg">
        <div className="tibia-panel p-6 flex flex-col items-center text-center gap-4">
          <p className="text-lg my-2 font-bold">SE OCORRER ERRO FALLBACK OU DE API, ME AVISE CLICANDO NO BOTAO SUGERIR ALGO QUE ESTA LOCALIZADO NO POPUP DO POPUP, POIS ESTOU USANDO API GRATIS.</p>
